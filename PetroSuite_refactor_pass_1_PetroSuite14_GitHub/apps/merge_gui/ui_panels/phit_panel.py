...
class PhitPanel(QWidget):
    ...
    def refresh(self):
        ...
        rhob_candidates = family_matches(cols, "RHOB")
        tnph_candidates = family_matches(cols, "TNPH")
        ...
        rhob_default = params.get("rhob_curve") or best_curve(cols, "RHOB")
        tnph_default = params.get("tnph_curve") or best_curve(cols, "TNPH")
