...
import numpy as np
import pandas as pd
from petrocore.config.curve_aliases import family_matches, family_candidates
...
class VshPanel(QWidget):
    ...
    def refresh(self):
        ...
        gr_cols = family_matches(cols, "GR")
        dt_cols = family_matches(cols, "DTCO")
        rhob_cols = family_matches(cols, "RHOB")
        nphi_cols = family_matches(cols, "TNPH")
