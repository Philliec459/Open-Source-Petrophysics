...
- [Chicheng Xu's lognormal Gaussian method used to derive Gaussian fit parameters to model HMPI data](https://github.com/Philliec459/Open-Source-Petrophysics/blob/main/Panel_Bvocc_ver5_GitHub_colab.ipynb)
