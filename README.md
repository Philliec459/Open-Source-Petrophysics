...
- [We have studied the works of Buiting and Clerke (5,6) that are used to upscale the Capillary Pressure data and Permeability based in reservoir-scale uncertainty in the intial displacement pressure Pd and Geometric factor G](https://github.com/Philliec459/Open-Source-Petrophysics/blob/main/Upscaled_BVocc_BC_Perm/SatHg_LinkedIn.ipynb)
